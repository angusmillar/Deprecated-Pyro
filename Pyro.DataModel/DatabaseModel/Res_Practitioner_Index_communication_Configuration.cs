...
{
  public class Res_Practitioner_Index_communication_Configuration : EntityTypeConfiguration<Res_Practitioner_Index_communication>
  {

    public Res_Practitioner_Index_communication_Configuration()
    {
