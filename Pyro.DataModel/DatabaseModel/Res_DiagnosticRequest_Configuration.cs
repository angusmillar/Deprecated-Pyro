...
{
  public class Res_DiagnosticRequest_Configuration : EntityTypeConfiguration<Res_DiagnosticRequest>
  {

    public Res_DiagnosticRequest_Configuration()
    {
      HasKey(x => x.Res_DiagnosticRequestID).Property(x => x.Res_DiagnosticRequestID).IsRequired();
