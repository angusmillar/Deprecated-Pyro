...
{
  public class Res_RelatedPerson_Index_address_use_Configuration : EntityTypeConfiguration<Res_RelatedPerson_Index_address_use>
  {

    public Res_RelatedPerson_Index_address_use_Configuration()
    {
