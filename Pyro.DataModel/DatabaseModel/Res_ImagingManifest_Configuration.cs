...
{
  public class Res_ImagingManifest_Configuration : EntityTypeConfiguration<Res_ImagingManifest>
  {

    public Res_ImagingManifest_Configuration()
    {
      HasKey(x => x.Res_ImagingManifestID).Property(x => x.Res_ImagingManifestID).IsRequired();
