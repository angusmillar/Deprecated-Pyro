...
{
  public class Res_NutritionRequest_Configuration : EntityTypeConfiguration<Res_NutritionRequest>
  {

    public Res_NutritionRequest_Configuration()
    {
      HasKey(x => x.Res_NutritionRequestID).Property(x => x.Res_NutritionRequestID).IsRequired();
