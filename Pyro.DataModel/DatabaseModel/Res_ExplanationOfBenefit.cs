...
namespace Pyro.DataModel.DatabaseModel
{
  ...
  public class Res_ExplanationOfBenefit : ResourceIndexBase
  {
    ...
    public virtual ServiceRootURL_Store claimreference_Url { get; set; }
    public int? claimreference_ServiceRootURL_StoreID { get; set; }
    ...
    public ICollection<Res_ExplanationOfBenefit_Index__profile> _profile_List { get; set; }
    public ICollection<Res_ExplanationOfBenefit_Index__security> _security_List { get; set; }
    public ICollection<Res_ExplanationOfBenefit_Index__tag> _tag_List { get; set; }
   
    public Res_ExplanationOfBenefit()
    {
      this.identifier_List = new HashSet<Res_ExplanationOfBenefit_Index_identifier>();
      this._profile_List = new HashSet<Res_ExplanationOfBenefit_Index__profile>();
      this._security_List = new HashSet<Res_ExplanationOfBenefit_Index__security>();
      this._tag_List = new HashSet<Res_ExplanationOfBenefit_Index__tag>();
