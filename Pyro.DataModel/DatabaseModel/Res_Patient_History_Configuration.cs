...
namespace Blaze.DataModel.DatabaseModel
{
  public class Res_Patient_History_Configuration : EntityTypeConfiguration<Res_Patient_History>
  {
    ...
    {
      HasKey(x => x.Res_Patient_HistoryID).Property(x => x.Res_Patient_HistoryID).IsRequired();
      ...
      HasRequired(x => x.Res_Patient).WithMany(x => x.Res_Patient_History_List).WillCascadeOnDelete(false);
    }
  }
}
