...
namespace Blaze.DataModel.DatabaseModel
{
  public class Res_Procedure_History_Configuration : EntityTypeConfiguration<Res_Procedure_History>
  {
    ...
    {
      HasKey(x => x.Res_Procedure_HistoryID).Property(x => x.Res_Procedure_HistoryID).IsRequired();
      ...
      HasRequired(x => x.Res_Procedure).WithMany(x => x.Res_Procedure_History_List).WillCascadeOnDelete(false);
    }
  }
}
