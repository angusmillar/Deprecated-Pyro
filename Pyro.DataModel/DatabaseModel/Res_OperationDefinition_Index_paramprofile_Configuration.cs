...
{
  public class Res_OperationDefinition_Index_paramprofile_Configuration : EntityTypeConfiguration<Res_OperationDefinition_Index_paramprofile>
  {
    ...
    public Res_OperationDefinition_Index_paramprofile_Configuration()
    {
      ...
      HasRequired(x => x.Res_OperationDefinition).WithMany(x => x.paramprofile_List).WillCascadeOnDelete(true);
    }
  }
}
