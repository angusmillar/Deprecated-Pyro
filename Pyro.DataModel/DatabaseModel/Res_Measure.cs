...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_Measure : ResourceIndexBase
  {
    ...
    public ICollection<Res_Measure_Index__profile> _profile_List { get; set; }
    public ICollection<Res_Measure_Index__security> _security_List { get; set; }
    public ICollection<Res_Measure_Index__tag> _tag_List { get; set; }
   
    public Res_Measure()
    {
      this.identifier_List = new HashSet<Res_Measure_Index_identifier>();
      this.topic_List = new HashSet<Res_Measure_Index_topic>();
      this._profile_List = new HashSet<Res_Measure_Index__profile>();
      this._security_List = new HashSet<Res_Measure_Index__security>();
      this._tag_List = new HashSet<Res_Measure_Index__tag>();
