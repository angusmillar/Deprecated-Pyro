...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public ImplementationGuideRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.ImplementationGuide; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ImplementationGuide_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ImplementationGuide_History_List).Count();      
    }
