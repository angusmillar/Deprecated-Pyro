...
{
  public partial class ProcessResponseRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_ProcessResponse, new() 
    where ResourceHistoryType :Res_ProcessResponse_History, new()
  {
