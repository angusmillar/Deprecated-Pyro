...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public ProcessResponseRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.ProcessResponse; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ProcessResponse_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ProcessResponse_History_List).Count();      
    }
