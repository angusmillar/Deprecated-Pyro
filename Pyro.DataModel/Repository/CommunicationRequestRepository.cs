...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public CommunicationRequestRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.CommunicationRequest; }
