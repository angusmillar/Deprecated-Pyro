...
{
  public partial class StructureMapRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_StructureMap, new() 
    where ResourceHistoryType :Res_StructureMap_History, new()
  {
