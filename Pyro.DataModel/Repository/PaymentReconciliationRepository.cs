...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public PaymentReconciliationRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.PaymentReconciliation; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_PaymentReconciliation_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_PaymentReconciliation_History_List).Count();      
    }
