...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public DocumentManifestRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.DocumentManifest; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DocumentManifest_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DocumentManifest_History_List).Count();      
    }
