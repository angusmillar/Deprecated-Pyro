...
{
  public partial class PersonRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_Person, new() 
    where ResourceHistoryType :Res_Person_History, new()
  {
