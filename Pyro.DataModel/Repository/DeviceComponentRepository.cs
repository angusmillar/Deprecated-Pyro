...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public DeviceComponentRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.DeviceComponent; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DeviceComponent_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DeviceComponent_History_List).Count();      
    }
