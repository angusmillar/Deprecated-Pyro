...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public MedicationDispenseRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.MedicationDispense; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_MedicationDispense_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_MedicationDispense_History_List).Count();      
    }
