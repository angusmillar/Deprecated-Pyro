...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public EligibilityRequestRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.EligibilityRequest; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_EligibilityRequest_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_EligibilityRequest_History_List).Count();      
    }
