...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public VisionPrescriptionRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.VisionPrescription; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_VisionPrescription_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_VisionPrescription_History_List).Count();      
    }
