...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public FamilyMemberHistoryRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.FamilyMemberHistory; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_FamilyMemberHistory_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_FamilyMemberHistory_History_List).Count();      
    }
