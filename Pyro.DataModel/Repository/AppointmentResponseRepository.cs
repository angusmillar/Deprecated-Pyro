...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public AppointmentResponseRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.AppointmentResponse; }
