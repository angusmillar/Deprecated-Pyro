...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public PractitionerRoleRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.PractitionerRole; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_PractitionerRole_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_PractitionerRole_History_List).Count();      
    }
