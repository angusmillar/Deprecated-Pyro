...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public StructureDefinitionRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.StructureDefinition; }
