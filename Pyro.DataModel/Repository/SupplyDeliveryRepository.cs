...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public SupplyDeliveryRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.SupplyDelivery; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_SupplyDelivery_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_SupplyDelivery_History_List).Count();      
    }
