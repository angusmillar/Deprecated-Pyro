...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public DiagnosticReportRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.DiagnosticReport; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DiagnosticReport_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DiagnosticReport_History_List).Count();      
    }
