...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public ImagingManifestRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.ImagingManifest; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ImagingManifest_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ImagingManifest_History_List).Count();      
    }
