...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public NamingSystemRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.NamingSystem; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_NamingSystem_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_NamingSystem_History_List).Count();      
    }
