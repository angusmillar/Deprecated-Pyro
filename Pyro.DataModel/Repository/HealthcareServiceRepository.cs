...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public HealthcareServiceRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.HealthcareService; }
