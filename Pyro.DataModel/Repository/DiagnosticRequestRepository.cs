...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public DiagnosticRequestRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.DiagnosticRequest; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DiagnosticRequest_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DiagnosticRequest_History_List).Count();      
    }
