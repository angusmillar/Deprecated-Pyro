...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public ReferralRequestRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.ReferralRequest; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ReferralRequest_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ReferralRequest_History_List).Count();      
    }
