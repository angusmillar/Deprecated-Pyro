...
namespace Pyro.DataModel.Repository
{
     ...
     where ResourceHistoryType : Res_Patient_History, new()
  {
    ...
    public PatientRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.Patient; }
    ...
    protected override void PopulateResourceEntity(ResourceType ResourceEntity, string ResourceVersion, Resource Resource, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      foreach (ModelInfo.SearchParamDefinition index in searchparameters)
      {
        Hl7.Fhir.FhirPath.PocoNavigator nav = new Hl7.Fhir.FhirPath.PocoNavigator(Resource);
