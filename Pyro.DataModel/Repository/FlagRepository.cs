...
{
  public partial class FlagRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_Flag, new() 
    where ResourceHistoryType :Res_Flag_History, new()
  {
