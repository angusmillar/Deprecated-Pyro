...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public FlagRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.Flag; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_Flag_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_Flag_History_List).Count();      
    }
