...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public ImagingStudyRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.ImagingStudy; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ImagingStudy_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ImagingStudy_History_List).Count();      
    }
