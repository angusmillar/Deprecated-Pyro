...
{
  public partial class QuestionnaireRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_Questionnaire, new() 
    where ResourceHistoryType :Res_Questionnaire_History, new()
  {
