...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public OperationDefinitionRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.OperationDefinition; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_OperationDefinition_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_OperationDefinition_History_List).Count();      
    }
