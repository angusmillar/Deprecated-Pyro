...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public ExplanationOfBenefitRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.ExplanationOfBenefit; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ExplanationOfBenefit_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_ExplanationOfBenefit_History_List).Count();      
    }
