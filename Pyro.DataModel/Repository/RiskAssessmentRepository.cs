...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public RiskAssessmentRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.RiskAssessment; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_RiskAssessment_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_RiskAssessment_History_List).Count();      
    }
