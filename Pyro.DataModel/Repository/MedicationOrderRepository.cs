...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public MedicationOrderRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.MedicationOrder; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_MedicationOrder_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_MedicationOrder_History_List).Count();      
    }
