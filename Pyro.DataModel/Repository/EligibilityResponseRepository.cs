...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public EligibilityResponseRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.EligibilityResponse; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_EligibilityResponse_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_EligibilityResponse_History_List).Count();      
    }
