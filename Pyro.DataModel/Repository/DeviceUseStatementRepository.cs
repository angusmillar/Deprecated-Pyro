...
{
  public partial class DeviceUseStatementRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_DeviceUseStatement, new() 
    where ResourceHistoryType :Res_DeviceUseStatement_History, new()
  {
