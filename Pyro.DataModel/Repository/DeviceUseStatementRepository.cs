...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public DeviceUseStatementRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.DeviceUseStatement; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DeviceUseStatement_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_DeviceUseStatement_History_List).Count();      
    }
