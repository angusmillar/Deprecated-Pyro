...
{
  public partial class MedicationStatementRepository<ResourceType, ResourceHistoryType> : CommonResourceRepository<ResourceType, ResourceHistoryType>, IResourceRepository 
    where ResourceType : Res_MedicationStatement, new() 
    where ResourceHistoryType :Res_MedicationStatement_History, new()
  {
