...
namespace Pyro.DataModel.Repository
{
  ...
  {
    public MedicationStatementRepository(DataModel.DatabaseModel.DatabaseContext Context) : base(Context) { this.RepositoryResourceType = FHIRAllTypes.MedicationStatement; }
    ...
    {
      var HistoryEntityList = DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_MedicationStatement_History_List)
    ...
    {
      return DbGetAll<ResourceType>(Predicate).SelectMany(y => y.Res_MedicationStatement_History_List).Count();      
    }
