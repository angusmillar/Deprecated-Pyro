...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_ProcessResponse : ResourceIndexBase
  {
    ...
    public ICollection<Res_ProcessResponse_Index_profile> profile_List { get; set; }
    public ICollection<Res_ProcessResponse_Index_security> security_List { get; set; }
    public ICollection<Res_ProcessResponse_Index_tag> tag_List { get; set; }
   
    public Res_ProcessResponse()
    {
      this.identifier_List = new HashSet<Res_ProcessResponse_Index_identifier>();
      this.profile_List = new HashSet<Res_ProcessResponse_Index_profile>();
      this.security_List = new HashSet<Res_ProcessResponse_Index_security>();
      this.tag_List = new HashSet<Res_ProcessResponse_Index_tag>();
