...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_ImagingExcerpt : ResourceIndexBase
  {
    ...
    public ICollection<Res_ImagingExcerpt_Index_meta_profile> meta_profile_List { get; set; }
    public ICollection<Res_ImagingExcerpt_Index_meta_security> meta_security_List { get; set; }
    public ICollection<Res_ImagingExcerpt_Index_meta_tag> meta_tag_List { get; set; }
    ...
    public Res_ImagingExcerpt()
    {
      ...
      this.meta_tag_List = new HashSet<Res_ImagingExcerpt_Index_meta_tag>();
      this.meta_security_List = new HashSet<Res_ImagingExcerpt_Index_meta_security>();
      this.meta_profile_List = new HashSet<Res_ImagingExcerpt_Index_meta_profile>();
