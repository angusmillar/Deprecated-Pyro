...
{
  public class Res_Bundle_Index_message_Configuration : EntityTypeConfiguration<Res_Bundle_Index_message>
  {
    ...
    public Res_Bundle_Index_message_Configuration()
    {
      ...
      HasRequired(x => x.Res_Bundle).WithMany(x => x.message_List).WillCascadeOnDelete(true);
    }
  }
}
