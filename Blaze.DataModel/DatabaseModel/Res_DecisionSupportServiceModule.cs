...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_DecisionSupportServiceModule : ResourceIndexBase
  {
    ...
    public ICollection<Res_DecisionSupportServiceModule_Index__profile> _profile_List { get; set; }
    public ICollection<Res_DecisionSupportServiceModule_Index__security> _security_List { get; set; }
    public ICollection<Res_DecisionSupportServiceModule_Index__tag> _tag_List { get; set; }
    ...
    public Res_DecisionSupportServiceModule()
    {
      ...
      this._profile_List = new HashSet<Res_DecisionSupportServiceModule_Index__profile>();
      this._security_List = new HashSet<Res_DecisionSupportServiceModule_Index__security>();
      this._tag_List = new HashSet<Res_DecisionSupportServiceModule_Index__tag>();
