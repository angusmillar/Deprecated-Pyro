...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_DecisionSupportServiceModule : ResourceIndexBase
  {
    ...
    public ICollection<Res_DecisionSupportServiceModule_Index_profile> profile_List { get; set; }
    public ICollection<Res_DecisionSupportServiceModule_Index_security> security_List { get; set; }
    public ICollection<Res_DecisionSupportServiceModule_Index_tag> tag_List { get; set; }
    ...
    public Res_DecisionSupportServiceModule()
    {
      ...
      this.profile_List = new HashSet<Res_DecisionSupportServiceModule_Index_profile>();
      this.security_List = new HashSet<Res_DecisionSupportServiceModule_Index_security>();
      this.tag_List = new HashSet<Res_DecisionSupportServiceModule_Index_tag>();
