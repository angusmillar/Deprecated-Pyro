...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_BodySite : ResourceIndexBase
  {
    ...
    public ICollection<Res_BodySite_Index_profile> profile_List { get; set; }
    public ICollection<Res_BodySite_Index_security> security_List { get; set; }
    public ICollection<Res_BodySite_Index_tag> tag_List { get; set; }
   
    public Res_BodySite()
    {
      this.code_List = new HashSet<Res_BodySite_Index_code>();
      this.identifier_List = new HashSet<Res_BodySite_Index_identifier>();
      this.profile_List = new HashSet<Res_BodySite_Index_profile>();
      this.security_List = new HashSet<Res_BodySite_Index_security>();
      this.tag_List = new HashSet<Res_BodySite_Index_tag>();
