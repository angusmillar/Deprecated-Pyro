...
{
  public class Res_EpisodeOfCare_Index_incomingreferral_Configuration : EntityTypeConfiguration<Res_EpisodeOfCare_Index_incomingreferral>
  {
    ...
    public Res_EpisodeOfCare_Index_incomingreferral_Configuration()
    {
      ...
      HasRequired(x => x.Res_EpisodeOfCare).WithMany(x => x.incomingreferral_List).WillCascadeOnDelete(true);
    }
  }
}
