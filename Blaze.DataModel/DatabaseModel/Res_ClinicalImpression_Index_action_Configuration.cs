...
{
  public class Res_ClinicalImpression_Index_action_Configuration : EntityTypeConfiguration<Res_ClinicalImpression_Index_action>
  {
    ...
    public Res_ClinicalImpression_Index_action_Configuration()
    {
      ...
      HasRequired(x => x.Res_ClinicalImpression).WithMany(x => x.action_List).WillCascadeOnDelete(true);
    }
  }
}
