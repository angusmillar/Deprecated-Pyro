...
{
  public class Res_Substance_Index_substance_Configuration : EntityTypeConfiguration<Res_Substance_Index_substance>
  {
    ...
    public Res_Substance_Index_substance_Configuration()
    {
      ...
      HasRequired(x => x.Res_Substance).WithMany(x => x.substance_List).WillCascadeOnDelete(true);
    }
  }
}
