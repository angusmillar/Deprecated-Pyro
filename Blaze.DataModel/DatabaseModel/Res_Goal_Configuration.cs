...
{
  public class Res_Goal_Configuration : EntityTypeConfiguration<Res_Goal>
  {

    public Res_Goal_Configuration()
    {
      HasKey(x => x.Res_GoalID).Property(x => x.Res_GoalID).IsRequired();
      ...
      Property(x => x.targetdate_DateTimeOffset).IsOptional();
    }
  }
}
