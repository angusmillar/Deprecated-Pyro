...
namespace Blaze.DataModel.DatabaseModel
{
  ...
  public class Res_DeviceUseStatement : ResourceIndexBase
  {
    ...
    public ICollection<Res_DeviceUseStatement_Index_profile> profile_List { get; set; }
    public ICollection<Res_DeviceUseStatement_Index_security> security_List { get; set; }
    public ICollection<Res_DeviceUseStatement_Index_tag> tag_List { get; set; }
   
    public Res_DeviceUseStatement()
    {
      this.profile_List = new HashSet<Res_DeviceUseStatement_Index_profile>();
      this.security_List = new HashSet<Res_DeviceUseStatement_Index_security>();
      this.tag_List = new HashSet<Res_DeviceUseStatement_Index_tag>();
