    ...
    private void PopulateResourceEntity(Res_Parameters ResourseEntity, string ResourceVersion, Parameters ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
          ...
          if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_Parameters_Index_profile(), item4) as Res_Parameters_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Parameters_Index_security(), item4) as Res_Parameters_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Parameters_Index_tag(), item4) as Res_Parameters_Index_tag;
