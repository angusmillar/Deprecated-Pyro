...
namespace Blaze.DataModel.Repository
{
  public partial class EnrollmentRequestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void ResetResourceEntity(Res_EnrollmentRequest ResourceEntity)
    {
      ...
      _Context.Res_EnrollmentRequest_Index_profile.RemoveRange(ResourceEntity.profile_List);            
      _Context.Res_EnrollmentRequest_Index_security.RemoveRange(ResourceEntity.security_List);            
      _Context.Res_EnrollmentRequest_Index_tag.RemoveRange(ResourceEntity.tag_List);            
    ...
    private void PopulateResourceEntity(Res_EnrollmentRequest ResourseEntity, string ResourceVersion, EnrollmentRequest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_EnrollmentRequest_Index_identifier(), item3) as Res_EnrollmentRequest_Index_identifier;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_EnrollmentRequest_Index_profile(), item4) as Res_EnrollmentRequest_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_EnrollmentRequest_Index_security(), item4) as Res_EnrollmentRequest_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_EnrollmentRequest_Index_tag(), item4) as Res_EnrollmentRequest_Index_tag;
