...
namespace Blaze.DataModel.Repository
{
  public partial class EnrollmentRequestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_EnrollmentRequest ResourseEntity, int ResourceVersion, EnrollmentRequest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
