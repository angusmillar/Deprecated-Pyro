...
namespace Blaze.DataModel.Repository
{
  public partial class DiagnosticOrderRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_DiagnosticOrder ResourseEntity, int ResourceVersion, DiagnosticOrder ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
