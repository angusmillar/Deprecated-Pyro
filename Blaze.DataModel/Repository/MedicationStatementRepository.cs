...
namespace Blaze.DataModel.Repository
{
  public partial class MedicationStatementRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_MedicationStatement ResourseEntity, string ResourceVersion, MedicationStatement ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      {
        {
          var Index = IndexSettingSupport.SetIndex<ReferenceIndex>(new ReferenceIndex(), ResourceTyped.InformationSource, FhirRequestUri, this);
          if (Index != null)
          {
      ...
      if (ResourceTyped.Medication != null)
      {
        if (ResourceTyped.Medication is CodeableConcept)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_MedicationStatement_Index_code(), item3) as Res_MedicationStatement_Index_code;
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_MedicationStatement_Index_identifier(), item3) as Res_MedicationStatement_Index_identifier;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_MedicationStatement_Index_profile(), item4) as Res_MedicationStatement_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_MedicationStatement_Index_security(), item4) as Res_MedicationStatement_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_MedicationStatement_Index_tag(), item4) as Res_MedicationStatement_Index_tag;
