...
namespace Blaze.DataModel.Repository
{
  public partial class MedicationStatementRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_MedicationStatement ResourseEntity, int ResourceVersion, MedicationStatement ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
