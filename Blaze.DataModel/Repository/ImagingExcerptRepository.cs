...
namespace Blaze.DataModel.Repository
{
  public partial class ImagingExcerptRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ImagingExcerpt ResourseEntity, int ResourceVersion, ImagingExcerpt ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
