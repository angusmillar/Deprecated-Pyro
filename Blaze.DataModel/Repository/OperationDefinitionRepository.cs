...
namespace Blaze.DataModel.Repository
{
  public partial class OperationDefinitionRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_OperationDefinition ResourseEntity, int ResourceVersion, OperationDefinition ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
