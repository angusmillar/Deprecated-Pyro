  ...
  public partial class StructureMapRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_StructureMap ResourseEntity, string ResourceVersion, StructureMap ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.UseContext != null)
      {
        foreach (var item3 in ResourceTyped.UseContext)
        {
          if (item3 != null)
          {
            ...
            {
              var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_StructureMap_Index_context(), item4) as Res_StructureMap_Index_context;
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_StructureMap_Index_identifier(), item3) as Res_StructureMap_Index_identifier;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_StructureMap_Index_profile(), item4) as Res_StructureMap_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_StructureMap_Index_security(), item4) as Res_StructureMap_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_StructureMap_Index_tag(), item4) as Res_StructureMap_Index_tag;
