    ...
    private void PopulateResourceEntity(Res_ValueSet ResourseEntity, string ResourceVersion, ValueSet ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.Expansion != null)
      {
        if (ResourceTyped.Expansion.Identifier != null)
        {
          ...
          {
            UriIndex Index = null;
            Index = IndexSettingSupport.SetIndex(Index, ResourceTyped.Expansion.IdentifierElement) as UriIndex;
            if (Index != null)
            {
      ...
      if (ResourceTyped.UseContext != null)
      {
        foreach (var item3 in ResourceTyped.UseContext)
        {
          if (item3 != null)
          {
            ...
            {
              Res_ValueSet_Index_context Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_ValueSet_Index_context;
      ...
      if (ResourceTyped.Compose != null)
      {
        foreach (var item2 in ResourceTyped.Compose.Include)
        {
          if (item2.System != null)
          {
            ...
            {
              Res_ValueSet_Index_reference Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item2.SystemElement) as Res_ValueSet_Index_reference;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              Res_ValueSet_Index_profile Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_ValueSet_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            ...
            {
              Res_ValueSet_Index_security Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_ValueSet_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_ValueSet_Index_tag Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_ValueSet_Index_tag;
