...
namespace Blaze.DataModel.Repository
{
  public partial class PractitionerRoleRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_PractitionerRole ResourseEntity, int ResourceVersion, PractitionerRole ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
