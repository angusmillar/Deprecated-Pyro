...
namespace Blaze.DataModel.Repository
{
  public partial class MeasureReportRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_MeasureReport ResourseEntity, int ResourceVersion, MeasureReport ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
