  ...
  public partial class CareTeamRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_CareTeam ResourseEntity, string ResourceVersion, CareTeam ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CareTeam_Index_identifier(), item3) as Res_CareTeam_Index_identifier;
      ...
      foreach (var item1 in ResourceTyped.Participant)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<ReferenceIndex>(new Res_CareTeam_Index_participant(), item1.Member, FhirRequestUri, this) as Res_CareTeam_Index_participant;
          if (Index != null)
          {
      ...
      if (ResourceTyped.Status != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CareTeam_Index_status(), item3) as Res_CareTeam_Index_status;
      ...
      if (ResourceTyped.Type != null)
      {
        foreach (var item3 in ResourceTyped.Type)
        {
          if (item3 != null)
          {
            ...
            {
              var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CareTeam_Index_type(), item4) as Res_CareTeam_Index_type;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_CareTeam_Index_profile(), item4) as Res_CareTeam_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CareTeam_Index_security(), item4) as Res_CareTeam_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CareTeam_Index_tag(), item4) as Res_CareTeam_Index_tag;
