...
namespace Blaze.DataModel.Repository
{
  public partial class CommunicationRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_Communication ResourseEntity, int ResourceVersion, Communication ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
