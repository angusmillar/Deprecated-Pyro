...
namespace Blaze.DataModel.Repository
{
  public partial class VisionPrescriptionRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_VisionPrescription ResourseEntity, int ResourceVersion, VisionPrescription ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
