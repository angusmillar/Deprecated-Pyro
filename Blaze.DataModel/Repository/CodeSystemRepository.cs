    ...
    private void PopulateResourceEntity(Res_CodeSystem ResourseEntity, string ResourceVersion, CodeSystem ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      foreach (var item1 in ResourceTyped.Concept)
      {
        if (item1.Code != null)
        {
          ...
          {
            Res_CodeSystem_Index_code Index = null;
            Index = IndexSettingSupport.SetIndex(Index, item1.CodeElement) as Res_CodeSystem_Index_code;
      ...
      if (ResourceTyped.UseContext != null)
      {
        foreach (var item3 in ResourceTyped.UseContext)
        {
          if (item3 != null)
          {
            ...
            {
              Res_CodeSystem_Index_context Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_CodeSystem_Index_context;
      ...
      foreach (var item1 in ResourceTyped.Concept)
      {
        foreach (var item2 in item1.Designation)
        {
          if (item2.Language != null)
          {
            ...
            {
              Res_CodeSystem_Index_language Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item2.LanguageElement) as Res_CodeSystem_Index_language;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              Res_CodeSystem_Index_profile Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_CodeSystem_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            ...
            {
              Res_CodeSystem_Index_security Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_CodeSystem_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_CodeSystem_Index_tag Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_CodeSystem_Index_tag;
