  ...
  public partial class CodeSystemRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_CodeSystem ResourseEntity, string ResourceVersion, CodeSystem ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      foreach (var item1 in ResourceTyped.Concept)
      {
        if (item1.Code != null)
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CodeSystem_Index_code(), item1.CodeElement) as Res_CodeSystem_Index_code;
      ...
      if (ResourceTyped.UseContext != null)
      {
        foreach (var item3 in ResourceTyped.UseContext)
        {
          if (item3 != null)
          {
            ...
            {
              var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CodeSystem_Index_context(), item4) as Res_CodeSystem_Index_context;
      ...
      foreach (var item1 in ResourceTyped.Concept)
      {
        foreach (var item2 in item1.Designation)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CodeSystem_Index_language(), item2.LanguageElement) as Res_CodeSystem_Index_language;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_CodeSystem_Index_profile(), item4) as Res_CodeSystem_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CodeSystem_Index_security(), item4) as Res_CodeSystem_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_CodeSystem_Index_tag(), item4) as Res_CodeSystem_Index_tag;
