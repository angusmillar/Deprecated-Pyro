    ...
    private void PopulateResourceEntity(Res_OrderSet ResourseEntity, string ResourceVersion, OrderSet ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.ModuleMetadata != null)
      {
        if (ResourceTyped.ModuleMetadata.Identifier != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_OrderSet_Index_identifier(), item4) as Res_OrderSet_Index_identifier;
        ...
        if (ResourceTyped.ModuleMetadata.Topic != null)
        {
          foreach (var item4 in ResourceTyped.ModuleMetadata.Topic)
          {
            if (item4 != null)
            {
              ...
              {
                var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_OrderSet_Index_topic(), item5) as Res_OrderSet_Index_topic;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_OrderSet_Index_profile(), item4) as Res_OrderSet_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_OrderSet_Index_security(), item4) as Res_OrderSet_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_OrderSet_Index_tag(), item4) as Res_OrderSet_Index_tag;
