    ...
    private void PopulateResourceEntity(Res_QuestionnaireResponse ResourseEntity, string ResourceVersion, QuestionnaireResponse ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.Authored != null)
      {
        if (ResourceTyped.AuthoredElement is Hl7.Fhir.Model.FhirDateTime)
        {
          ...
          Index = IndexSetterFactory.Create(typeof(DateIndex)).Set(ResourceTyped.AuthoredElement, Index) as DateIndex;
          if (Index != null)
          {
        ...
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            if (item4 is Hl7.Fhir.Model.FhirUri)
            {
              ...
              Index = IndexSetterFactory.Create(typeof(UriIndex)).Set(item4, Index) as Res_QuestionnaireResponse_Index_profile;
        ...
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              ...
              Index = IndexSetterFactory.Create(typeof(TokenIndex)).Set(item4, Index) as Res_QuestionnaireResponse_Index_security;
        ...
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              ...
              Index = IndexSetterFactory.Create(typeof(TokenIndex)).Set(item4, Index) as Res_QuestionnaireResponse_Index_tag;
