...
namespace Blaze.DataModel.Repository
{
  public partial class DeviceUseStatementRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_DeviceUseStatement ResourseEntity, int ResourceVersion, DeviceUseStatement ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
