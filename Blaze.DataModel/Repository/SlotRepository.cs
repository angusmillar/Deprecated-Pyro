...
namespace Blaze.DataModel.Repository
{
  public partial class SlotRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_Slot ResourseEntity, string ResourceVersion, Slot ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      {
        {
          var Index = IndexSettingSupport.SetIndex<ReferenceIndex>(new ReferenceIndex(), ResourceTyped.Schedule, FhirRequestUri, this);
          if (Index != null)
          {
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Slot_Index_identifier(), item3) as Res_Slot_Index_identifier;
      ...
      if (ResourceTyped.ServiceType != null)
      {
        foreach (var item3 in ResourceTyped.ServiceType)
        {
          if (item3 != null)
          {
            ...
            {
              var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Slot_Index_slot_type(), item4) as Res_Slot_Index_slot_type;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_Slot_Index_profile(), item4) as Res_Slot_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Slot_Index_security(), item4) as Res_Slot_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Slot_Index_tag(), item4) as Res_Slot_Index_tag;
