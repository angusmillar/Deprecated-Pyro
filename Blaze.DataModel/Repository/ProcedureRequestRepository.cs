...
namespace Blaze.DataModel.Repository
{
  public partial class ProcedureRequestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ProcedureRequest ResourseEntity, int ResourceVersion, ProcedureRequest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
