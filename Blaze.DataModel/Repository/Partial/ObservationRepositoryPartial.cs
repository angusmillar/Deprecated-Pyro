...
namespace Blaze.DataModel.Repository
{
  public partial class ObservationRepository : CommonRepository, IResourceRepository
  {
    ...
    //  {
    //    if (!ResourceTyped.Device.IsContainedReference)
    //    {
    ...
    //  {
    //    if (!ResourceTyped.Encounter.IsContainedReference)
    //    {
    ...
    //  {
    //    if (!ResourceTyped.Subject.IsContainedReference)
    //    {
    ...
    //  {
    //    if (!ResourceTyped.Specimen.IsContainedReference)
    //    {
    ...
    //    if (item1.Value != null)
    //    {
    //      var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Observation_Index_component_value_concept(), item1.Value) as Res_Observation_Index_component_value_concept;
    ...
    //  if (ResourceTyped.Value != null)
    //  {
    //    var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Observation_Index_value_concept(), ResourceTyped.Value) as Res_Observation_Index_value_concept;
