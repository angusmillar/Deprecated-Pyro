...
namespace Blaze.DataModel.Repository
{
  public partial class RiskAssessmentRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_RiskAssessment ResourseEntity, int ResourceVersion, RiskAssessment ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
