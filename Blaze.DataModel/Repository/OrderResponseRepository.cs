    ...
    private void PopulateResourceEntity(Res_OrderResponse ResourseEntity, string ResourceVersion, OrderResponse ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
          ...
          if (ResourceTyped.OrderStatus_ != null)
      {
        if (ResourceTyped.OrderStatus_Element is Hl7.Fhir.Model.Code<Hl7.Fhir.Model.OrderResponse.OrderStatus>)
        {
          ...
          Index = IndexSettingSupport.SetIndex(Index, ResourceTyped.OrderStatus_Element) as TokenIndex;
          if (Index != null)
          {
      ...
      {
        if (ResourceTyped.Who is ResourceReference)
        {
          ReferenceIndex Index = null;
          Index = IndexSettingSupport.SetIndex(Index, ResourceTyped.Who, FhirRequestUri, this) as ReferenceIndex;
          if (Index != null)
          {
      ...
      if (ResourceTyped.Identifier != null)
      {
        foreach (var item3 in ResourceTyped.Identifier)
        {
          ...
          {
            Res_OrderResponse_Index_identifier Index = null;
            Index = IndexSettingSupport.SetIndex(Index, item3) as Res_OrderResponse_Index_identifier;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              Res_OrderResponse_Index_profile Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_OrderResponse_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            ...
            {
              Res_OrderResponse_Index_security Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_OrderResponse_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_OrderResponse_Index_tag Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_OrderResponse_Index_tag;
