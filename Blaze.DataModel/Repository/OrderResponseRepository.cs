...
namespace Blaze.DataModel.Repository
{
  public partial class OrderResponseRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_OrderResponse ResourseEntity, int ResourceVersion, OrderResponse ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
