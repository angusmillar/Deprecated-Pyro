...
namespace Blaze.DataModel.Repository
{
  public partial class ReferralRequestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ReferralRequest ResourseEntity, int ResourceVersion, ReferralRequest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
