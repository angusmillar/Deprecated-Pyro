...
namespace Blaze.DataModel.Repository
{
  public partial class ProcessResponseRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ProcessResponse ResourseEntity, int ResourceVersion, ProcessResponse ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
