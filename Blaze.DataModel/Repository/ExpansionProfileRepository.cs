...
namespace Blaze.DataModel.Repository
{
  public partial class ExpansionProfileRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ExpansionProfile ResourseEntity, int ResourceVersion, ExpansionProfile ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
