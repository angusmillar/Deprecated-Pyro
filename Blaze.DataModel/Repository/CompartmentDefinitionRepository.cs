...
namespace Blaze.DataModel.Repository
{
  public partial class CompartmentDefinitionRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_CompartmentDefinition ResourseEntity, int ResourceVersion, CompartmentDefinition ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
