...
namespace Blaze.DataModel.Repository
{
  public partial class ImmunizationRecommendationRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ImmunizationRecommendation ResourseEntity, int ResourceVersion, ImmunizationRecommendation ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
