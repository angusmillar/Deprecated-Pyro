...
namespace Blaze.DataModel.Repository
{
  public partial class NamingSystemRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_NamingSystem ResourseEntity, string ResourceVersion, NamingSystem ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      {
        if (ResourceTyped.ReplacedBy is ResourceReference)
        {
      ...
      foreach (var item1 in ResourceTyped.Contact)
      {
        if (item1.Name != null)
        {
          ...
          {
            Res_NamingSystem_Index_contact Index = null;
      ...
      if (ResourceTyped.UseContext != null)
      {
        foreach (var item3 in ResourceTyped.UseContext)
        {
          if (item3 != null)
          {
            ...
            {
              Res_NamingSystem_Index_context Index = null;
      ...
      foreach (var item1 in ResourceTyped.UniqueId)
      {
        if (item1.Type != null)
        {
          ...
          {
            Res_NamingSystem_Index_id_type Index = null;
      ...
      if (ResourceTyped.Type != null)
      {
        ...
        {
          Res_NamingSystem_Index_type Index = null;
      ...
      foreach (var item1 in ResourceTyped.UniqueId)
      {
        if (item1.Value != null)
        {
          ...
          {
            Res_NamingSystem_Index_value Index = null;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              Res_NamingSystem_Index_profile Index = null;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            ...
            {
              Res_NamingSystem_Index_security Index = null;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_NamingSystem_Index_tag Index = null;
