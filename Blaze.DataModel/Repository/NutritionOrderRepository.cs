...
namespace Blaze.DataModel.Repository
{
  public partial class NutritionOrderRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_NutritionOrder ResourseEntity, int ResourceVersion, NutritionOrder ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
