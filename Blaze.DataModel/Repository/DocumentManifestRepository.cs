...
namespace Blaze.DataModel.Repository
{
  public partial class DocumentManifestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_DocumentManifest ResourseEntity, int ResourceVersion, DocumentManifest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
