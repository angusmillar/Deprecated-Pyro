...
namespace Blaze.DataModel.Repository
{
  public partial class DeviceUseRequestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_DeviceUseRequest ResourseEntity, int ResourceVersion, DeviceUseRequest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
