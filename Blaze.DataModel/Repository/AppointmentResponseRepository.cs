...
namespace Blaze.DataModel.Repository
{
  public partial class AppointmentResponseRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_AppointmentResponse ResourseEntity, int ResourceVersion, AppointmentResponse ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
