...
namespace Blaze.DataModel.Repository
{
  public partial class StructureDefinitionRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_StructureDefinition ResourseEntity, int ResourceVersion, StructureDefinition ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
