    ...
    private void PopulateResourceEntity(Res_FamilyMemberHistory ResourseEntity, string ResourceVersion, FamilyMemberHistory ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      foreach (var item1 in ResourceTyped.Condition)
      {
        if (item1.Code != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_FamilyMemberHistory_Index_code(), item4) as Res_FamilyMemberHistory_Index_code;
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_FamilyMemberHistory_Index_identifier(), item3) as Res_FamilyMemberHistory_Index_identifier;
      ...
      if (ResourceTyped.Relationship != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_FamilyMemberHistory_Index_relationship(), item3) as Res_FamilyMemberHistory_Index_relationship;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_FamilyMemberHistory_Index_profile(), item4) as Res_FamilyMemberHistory_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_FamilyMemberHistory_Index_security(), item4) as Res_FamilyMemberHistory_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_FamilyMemberHistory_Index_tag(), item4) as Res_FamilyMemberHistory_Index_tag;
