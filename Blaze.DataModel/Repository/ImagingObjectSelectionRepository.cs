  ...
  public partial class ImagingObjectSelectionRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ImagingObjectSelection ResourseEntity, string ResourceVersion, ImagingObjectSelection ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      foreach (var item1 in ResourceTyped.Study)
      {
        if (item1.Uid != null)
        {
          var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_ImagingObjectSelection_Index_selected_study(), item1.UidElement) as Res_ImagingObjectSelection_Index_selected_study;
      ...
      if (ResourceTyped.Title != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_ImagingObjectSelection_Index_title(), item3) as Res_ImagingObjectSelection_Index_title;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_ImagingObjectSelection_Index_profile(), item4) as Res_ImagingObjectSelection_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_ImagingObjectSelection_Index_security(), item4) as Res_ImagingObjectSelection_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_ImagingObjectSelection_Index_tag(), item4) as Res_ImagingObjectSelection_Index_tag;
