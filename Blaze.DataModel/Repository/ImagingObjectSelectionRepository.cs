...
namespace Blaze.DataModel.Repository
{
  public partial class ImagingObjectSelectionRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ImagingObjectSelection ResourseEntity, int ResourceVersion, ImagingObjectSelection ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
