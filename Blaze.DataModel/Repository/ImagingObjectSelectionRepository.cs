...
namespace Blaze.DataModel.Repository
{
  public partial class ImagingObjectSelectionRepository : CommonRepository, IResourceRepository
  {
    ...
    {
      var Predicate = PredicateGenerator<Res_ImagingObjectSelection>(DtoSearchParameters);
      int TotalRecordCount = DbGetALLCount<Res_ImagingObjectSelection>(Predicate);
      var Query = DbGetAll<Res_ImagingObjectSelection>(Predicate);
    ...
    private void ResetResourceEntity(Res_ImagingObjectSelection ResourceEntity)
    {
      ...
      _Context.Res_ImagingObjectSelection_Index__profile.RemoveRange(ResourceEntity._profile_List);            
      _Context.Res_ImagingObjectSelection_Index__security.RemoveRange(ResourceEntity._security_List);            
      _Context.Res_ImagingObjectSelection_Index__tag.RemoveRange(ResourceEntity._tag_List);            
    ...
    private void PopulateResourceEntity(Res_ImagingObjectSelection ResourseEntity, string ResourceVersion, ImagingObjectSelection ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      foreach (var item1 in ResourceTyped.Study)
      {
        if (item1.Uid != null)
        {
          if (item1.UidElement is Hl7.Fhir.Model.Oid)
          {
            ...
            Index = IndexSetterFactory.Create(typeof(UriIndex)).Set(item1.UidElement, Index) as Res_ImagingObjectSelection_Index_selected_study;
      ...
      if (ResourceTyped.Title != null)
      {
        foreach (var item3 in ResourceTyped.Title.Coding)
        {
          ...
          Index = IndexSetterFactory.Create(typeof(TokenIndex)).Set(item3, Index) as Res_ImagingObjectSelection_Index_title;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              var Index = new Res_ImagingObjectSelection_Index__profile();
              Index = IndexSetterFactory.Create(typeof(UriIndex)).Set(item4, Index) as Res_ImagingObjectSelection_Index__profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            ...
            {
              var Index = new Res_ImagingObjectSelection_Index__security();
              Index = IndexSetterFactory.Create(typeof(TokenIndex)).Set(item4, Index) as Res_ImagingObjectSelection_Index__security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              var Index = new Res_ImagingObjectSelection_Index__tag();
              Index = IndexSetterFactory.Create(typeof(TokenIndex)).Set(item4, Index) as Res_ImagingObjectSelection_Index__tag;
