...
namespace Blaze.DataModel.Repository
{
  public partial class ProcessRequestRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_ProcessRequest ResourseEntity, int ResourceVersion, ProcessRequest ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
