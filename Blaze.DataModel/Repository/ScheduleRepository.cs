...
namespace Blaze.DataModel.Repository
{
  public partial class ScheduleRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_Schedule ResourseEntity, string ResourceVersion, Schedule ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      {
        {
          var Index = IndexSettingSupport.SetIndex<ReferenceIndex>(new ReferenceIndex(), ResourceTyped.Actor, FhirRequestUri, this);
          if (Index != null)
          {
      ...
      {
        var Index = IndexSettingSupport.SetIndex<DateIndex>(new DateIndex(), ResourceTyped.PlanningHorizon);
        if (Index != null)
        {
      ...
      if (ResourceTyped.Identifier != null)
      {
        ...
        {
          var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Schedule_Index_identifier(), item3) as Res_Schedule_Index_identifier;
      ...
      if (ResourceTyped.ServiceType != null)
      {
        foreach (var item3 in ResourceTyped.ServiceType)
        {
          if (item3 != null)
          {
            ...
            {
              var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Schedule_Index_type(), item4) as Res_Schedule_Index_type;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<UriIndex>(new Res_Schedule_Index_profile(), item4) as Res_Schedule_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Schedule_Index_security(), item4) as Res_Schedule_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          ...
          {
            var Index = IndexSettingSupport.SetIndex<TokenIndex>(new Res_Schedule_Index_tag(), item4) as Res_Schedule_Index_tag;
