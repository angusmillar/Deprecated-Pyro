      ...
      if (ResourceTyped.ModuleMetadata != null)
      {
        if (ResourceTyped.ModuleMetadata.Identifier != null)
        {
          foreach (var item4 in ResourceTyped.ModuleMetadata.Identifier)
          {
            ...
            {
              Res_Library_Index_identifier Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_Library_Index_identifier;
        ...
        if (ResourceTyped.ModuleMetadata.Topic != null)
        {
          foreach (var item4 in ResourceTyped.ModuleMetadata.Topic)
          {
            if (item4 != null)
            {
              ...
              {
                Res_Library_Index_topic Index = null;
                Index = IndexSettingSupport.SetIndex(Index, item5) as Res_Library_Index_topic;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              Res_Library_Index_profile Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_Library_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            ...
            {
              Res_Library_Index_security Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_Library_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_Library_Index_tag Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_Library_Index_tag;
