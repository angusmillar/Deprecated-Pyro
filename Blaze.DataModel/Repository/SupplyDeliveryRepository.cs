...
namespace Blaze.DataModel.Repository
{
  public partial class SupplyDeliveryRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_SupplyDelivery ResourseEntity, int ResourceVersion, SupplyDelivery ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
