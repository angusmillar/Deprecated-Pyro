  ...
  public partial class DataElementRepository : CommonRepository, IResourceRepository
  {
    ...
    private void PopulateResourceEntity(Res_DataElement ResourseEntity, string ResourceVersion, DataElement ResourceTyped, IDtoFhirRequestUri FhirRequestUri)
    {
      ...
      if (ResourceTyped.Stringency != null)
      {
        ...
        {
          TokenIndex Index = null;
          Index = IndexSettingSupport.SetIndex(Index, ResourceTyped.StringencyElement) as TokenIndex;
          if (Index != null)
          {
      ...
      foreach (var item1 in ResourceTyped.Element)
      {
        if (item1.Code != null)
        {
          foreach (var item4 in item1.Code)
          {
            ...
            {
              Res_DataElement_Index_code Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_DataElement_Index_code;
      ...
      if (ResourceTyped.UseContext != null)
      {
        foreach (var item3 in ResourceTyped.UseContext)
        {
          if (item3 != null)
          {
            ...
            {
              Res_DataElement_Index_context Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_DataElement_Index_context;
      ...
      foreach (var item1 in ResourceTyped.Element)
      {
        if (item1.Definition != null)
        {
          ...
          {
            Res_DataElement_Index_description Index = null;
            Index = IndexSettingSupport.SetIndex(Index, item1.DefinitionElement) as Res_DataElement_Index_description;
      ...
      if (ResourceTyped.Identifier != null)
      {
        foreach (var item3 in ResourceTyped.Identifier)
        {
          ...
          {
            Res_DataElement_Index_identifier Index = null;
            Index = IndexSettingSupport.SetIndex(Index, item3) as Res_DataElement_Index_identifier;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Profile != null)
        {
          foreach (var item4 in ResourceTyped.Meta.ProfileElement)
          {
            ...
            {
              Res_DataElement_Index_profile Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_DataElement_Index_profile;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Security != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Security)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_DataElement_Index_security Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_DataElement_Index_security;
      ...
      if (ResourceTyped.Meta != null)
      {
        if (ResourceTyped.Meta.Tag != null)
        {
          foreach (var item4 in ResourceTyped.Meta.Tag)
          {
            if (item4 is Hl7.Fhir.Model.Coding)
            {
              Res_DataElement_Index_tag Index = null;
              Index = IndexSettingSupport.SetIndex(Index, item4) as Res_DataElement_Index_tag;
