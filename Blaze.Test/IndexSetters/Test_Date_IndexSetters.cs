...
namespace Blaze.Test.IndexSetters
{
  ...
  class Test_Date_IndexSetters
  {
    ...
    public void Test_Date_DateIndexSetter_GoodFormat()
    {
      ...
      //Act
      DateIndex Index = IndexSetterFactory.Create(typeof(DateIndex)).Set(Date) as DateIndex;
    ...
    public void Test_FhirDateTime_DateIndexSetter_GoodFormat()
    {
      ...
      //Act
      DateIndex Index = IndexSetterFactory.Create(typeof(DateIndex)).Set(FhirDateTime) as DateIndex;
    ...
    public void Test_FhirString_DateIndexSetter_DateTime_GoodFormat()
    {
      ...
      //Act
      DateIndex Index = IndexSetterFactory.Create(typeof(DateIndex)).Set(FhirString) as DateIndex;
    ...
    public void Test_FhirString_DateIndexSetter_BadFormat()
    {
      ...
      //Act
      DateIndex DateIndex = IndexSetterFactory.Create(typeof(DateIndex)).Set(FhirString) as DateIndex;
    ...
    public void Test_Instant_DateIndexSetter_GoodFormat()
    {
      ...
      //Act
      DateIndex Index = IndexSetterFactory.Create(typeof(DateIndex)).Set(Instant) as DateIndex;
