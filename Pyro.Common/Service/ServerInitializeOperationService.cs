...
namespace Pyro.Common.Service
{
  public class ServerInitializeOperationService
  {
    ...
    private readonly IBundleTransactionService IBundleTransactionService;
    ...
    public ServerInitializeOperationService(
      ...
      IBundleTransactionService IBundleTransactionService)
    {
      ...
      this.IBundleTransactionService = IBundleTransactionService;
    }
    ...
    public IResourceServiceOutcome Initialize(OperationClass OperationClass, IRequestMeta RequestMeta, string FhirId)
    {
      ...
      if (ResourceList.Count > 0)
      {
        ...
        IResourceServiceOutcome ResourceServiceOutcome = IBundleTransactionService.Transact(TransactionBundle, CurrentRequestMeta);
