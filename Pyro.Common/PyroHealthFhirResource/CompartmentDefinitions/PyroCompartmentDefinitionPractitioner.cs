...
{
  public class PyroCompartmentDefinitionPractitioner : IPyroCompartmentDefinitionPractitioner
  {    
    private readonly CodeSystems.IPyroFhirServer IPyroFhirServerCodeSystem;
  
    public PyroCompartmentDefinitionPractitioner(CodeSystems.IPyroFhirServer IPyroFhirServerCodeSystem)
    {      
      this.IPyroFhirServerCodeSystem = IPyroFhirServerCodeSystem;
    }

    private static string ResourceId = "pyro-practitioner";
    ...
    { 
      var ResourceBase = Common.Tools.FhirResourceSerializationSupport.DeSerializeFromXml(CommonResource.PyroCompartmentDefinitionPractitioner);
