...
{
  public class PyroCompartmentDefinitionPatient : IPyroCompartmentDefinitionPatient
  {    
    private readonly CodeSystems.IPyroFhirServer IPyroFhirServerCodeSystem;
  
    public PyroCompartmentDefinitionPatient(CodeSystems.IPyroFhirServer IPyroFhirServerCodeSystem)
    {      
    ...
    { 
      var ResourceBase = Common.Tools.FhirResourceSerializationSupport.DeSerializeFromXml(CommonResource.PyroCompartmentDefinitionPatient);
