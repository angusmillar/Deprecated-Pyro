...
{
    /// <summary>
    /// This Class is here to handle any unique methods required for ConceptMap resource beyond the basic REST operations.
    /// These might be FHIR operations on the resource such as '$expand' in the ConceptMap Resource.
    /// </summary>
    public class ConceptMapResourceServices : BaseResourceServices, IConceptMapResourceServices, IBaseResourceServices
    {
        public override DtoEnums.SupportedFhirResource CurrentResourceType
        {
            get
            {
                return DtoEnums.SupportedFhirResource.ConceptMap;
            }
        }

        // Add
        // POST: URL/FhirApi/ConceptMap
        public override IBlazeServiceOperationOutcome Post(Resource FhirResource)
        {
            ...
            var FhirResourceTyped = FhirResource as ConceptMap;
            ...
            oBlazeServiceOperationOutcome.FhirResourceId = _UnitOfWork.ConceptMapRepository.AddResource(FhirResourceTyped);
        ...
        public override IBlazeServiceOperationOutcome Put(string FhirResourceId, Resource FhirResource)
        {
            ...
            if (oDtoResourceWithNoXml != null)
            {
                ...
                if (oDtoResourceWithNoXml.FhirResourceType == CurrentResourceType)
                {
                    ...
                    _UnitOfWork.ConceptMapRepository.UpdateResource(NewResourceVersionNumber, FhirResourceTyped);
                    oBlazeServiceOperationOutcome.OperationType = BusinessEntities.DtoEnums.CrudOperationType.Update;
        ...
        //Delete
        // DELETE: URL/FhirApi/ConceptMap/5
        public override IBlazeServiceOperationOutcome Delete(string FhirResourceId)
        {
            ...
            if (_UnitOfWork.ResourceRepository.ResourceExists(FhirResourceId))
            {
                ...
                if (ExsistingResourceTypeForFhirID == DtoEnums.SupportedFhirResource.ConceptMap)
                {
                    if (!_UnitOfWork.ResourceRepository.IsCurrentResourceDeleted(FhirResourceId))
                    {
                        _UnitOfWork.ConceptMapRepository.UpdateResouceAsDeleted(FhirResourceId);
                    }
        ...
        public ConceptMapResourceServices(IUnitOfWork IUnitOfWork)
          : base(IUnitOfWork)
        { }
    }
}
