...
namespace Pyro.DataLayer.DbModel.DatabaseContextConfig
{
  public class FhirReleaseContextConfig : EntityTypeConfiguration<_FhirRelease>
  {
    public FhirReleaseContextConfig()
    {
      ...
      HasMany(c => c.EntryDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.ItemInstanceList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.MedicinalProductClinicalsList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.MedicinalProductDeviceSpecList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.UserSessionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
