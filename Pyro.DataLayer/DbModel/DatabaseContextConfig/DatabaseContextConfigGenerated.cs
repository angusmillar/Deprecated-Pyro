...
namespace Pyro.DataLayer.DbModel.DatabaseContextConfig
{
  public class FhirReleaseContextConfig : ConfigEntityBaseConfig<_FhirRelease>
  {
    public FhirReleaseContextConfig()
    {
      ...
      HasMany(c => c.BiologicallyDerivedProductList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.BodyStructureList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.CatalogEntryList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.ChargeItemList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.ChargeItemDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.CoverageEligibilityRequestList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.CoverageEligibilityResponseList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.DeviceDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.EffectEvidenceSynthesisList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.EventDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.EvidenceList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.EvidenceVariableList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.ExampleScenarioList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.ImmunizationEvaluationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.InsurancePlanList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.InvoiceList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.MedicationKnowledgeList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.MedicinalProductList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductAuthorizationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductContraindicationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductIndicationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductIngredientList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductInteractionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductManufacturedList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductPackagedList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductPharmaceuticalList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.MedicinalProductUndesirableEffectList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.MolecularSequenceList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.ObservationDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.OrganizationAffiliationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.ResearchDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.ResearchElementDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.RiskEvidenceSynthesisList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.ServiceRequestList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.SpecimenDefinitionList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.SubstanceNucleicAcidList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.SubstancePolymerList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.SubstanceProteinList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.SubstanceReferenceInformationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.SubstanceSourceMaterialList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      HasMany(c => c.SubstanceSpecificationList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.TerminologyCapabilitiesList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
      ...
      HasMany(c => c.VerificationResultList).WithRequired(c => c.FhirRelease).HasForeignKey(m => m.FhirReleaseId).WillCascadeOnDelete(false);
