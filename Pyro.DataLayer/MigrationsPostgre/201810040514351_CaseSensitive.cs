namespace Pyro.DataLayer.MigrationsPostgre
{
    ...
    public partial class CaseSensitive : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("public.EntryDefinitionRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.EntryDefinitionRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.EntryDefinitionIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.EntryDefinitionIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.EntryDefinitionIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ItemInstanceRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ItemInstanceRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ItemInstanceIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ItemInstanceIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ItemInstanceIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductClinicalsRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductClinicalsRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductClinicalsIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductClinicalsIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductClinicalsIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductDeviceSpecRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductDeviceSpecRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductDeviceSpecIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductDeviceSpecIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.MedicinalProductDeviceSpecIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessRequestRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessRequestRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessRequestIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessRequestIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessRequestIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessResponseRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessResponseRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessResponseIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessResponseIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.ProcessResponseIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.SequenceRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.SequenceRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.SequenceIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.SequenceIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.SequenceIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.UserSessionRes", "FhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.UserSessionRes", "VersionId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.UserSessionIxRef", "ReferenceFhirId", c => c.String(nullable: false, maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.UserSessionIxRef", "ReferenceVersionId", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            AlterColumn("public.UserSessionIxTok", "Code", c => c.String(maxLength: 128,
                annotations: new Dictionary<string, AnnotationValues>
                {
                    { 
                        "CaseSensitive",
            ...
            CreateIndex("public.EntryDefinitionRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.EntryDefinitionIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.EntryDefinitionIxTok", "Code", name: "ix_Code");
            ...
            CreateIndex("public.ItemInstanceRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.ItemInstanceIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.ItemInstanceIxTok", "Code", name: "ix_Code");
            ...
            CreateIndex("public.MedicinalProductClinicalsRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.MedicinalProductClinicalsIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.MedicinalProductClinicalsIxTok", "Code", name: "ix_Code");
            ...
            CreateIndex("public.MedicinalProductDeviceSpecRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.MedicinalProductDeviceSpecIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.MedicinalProductDeviceSpecIxTok", "Code", name: "ix_Code");
            ...
            CreateIndex("public.ProcessRequestRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.ProcessRequestIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.ProcessRequestIxTok", "Code", name: "ix_Code");
            CreateIndex("public.ProcessResponseRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.ProcessResponseIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.ProcessResponseIxTok", "Code", name: "ix_Code");
            ...
            CreateIndex("public.SequenceRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.SequenceIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.SequenceIxTok", "Code", name: "ix_Code");
            ...
            CreateIndex("public.UserSessionRes", new[] { "FhirId", "VersionId" }, unique: true, name: "uq_FhirIdAndVersionId");
            CreateIndex("public.UserSessionIxRef", "ReferenceFhirId", name: "ix_RefFhirId");
            CreateIndex("public.UserSessionIxTok", "Code", name: "ix_Code");
